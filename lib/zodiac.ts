...
export const ZODIAC_SIGNS: readonly ZodiacProfile[] = [
  {
    ...
    planet: "Ангараг",
    quality: "cardinal",
    traits: ["Манлайлагч", "Эрч хүчтэй", "Шударга", "Зоригтой"],
    love: "Мэдрэмжээ шууд илэрхийлдэг, зоригтой бөгөөд харилцаанд идэвхтэй байдаг.",
    chatStyle: "Шулуухан, шуурхай хариулдаг, урт орох дуртай.",
